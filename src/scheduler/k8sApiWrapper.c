...
void create_pod(apiClient_t *apiClient)
{
    ...
    char *mem = ((v1_container_t *)(containerlist->firstEntry->data))->name;
    printf("%s\n", mem);
...
// bool create(apiClient_t *apiClient, , v1_pod_t *podinfo, char *namespa)
// {
// }
